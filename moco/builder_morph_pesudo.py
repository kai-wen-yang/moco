...
class MoCo(nn.Module):
    ...
    def forward(self, im_q, im_k=None, is_eval=False, is_target=False, centroids=None, index=None, im2cluster=None, density=None, temp=None):
        """
        Input:
        ...
        if is_target:
            ...
            q = nn.functional.normalize(q, dim=1)
            logits_q = torch.mm(q, centroids.t())
            logits_k = torch.mm(k, centroids.t())
            ...
            return logits_q, labels_proto, max_probs
